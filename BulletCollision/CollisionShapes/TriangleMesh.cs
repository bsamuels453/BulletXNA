...
namespace BulletXNA.BulletCollision
{
    public class TriangleMesh : TriangleIndexVertexArray
    {
        ...
        public int FindOrAddVertex(ref MonoGameUtility.Vector3 vertex, bool removeDuplicateVertices)
        {
        ...
        public void AddTriangle(MonoGameUtility.Vector3 vertex0, MonoGameUtility.Vector3 vertex1, MonoGameUtility.Vector3 vertex2)
        {
            AddTriangle(ref vertex0, ref vertex1, ref vertex2);
        }

        public void AddTriangle(ref MonoGameUtility.Vector3 vertex0, ref MonoGameUtility.Vector3 vertex1, ref MonoGameUtility.Vector3 vertex2)
        {
            AddTriangle(ref vertex0, ref vertex1, ref vertex2, false);
        }
        public void AddTriangle(ref MonoGameUtility.Vector3 vertex0, ref MonoGameUtility.Vector3 vertex1, ref MonoGameUtility.Vector3 vertex2, bool removeDuplicateVertices)
        {
